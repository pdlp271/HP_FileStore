...
PICS = (environ.get('PICS', 'https://graph.org/file/bb6c36ca99a22df3b58d8-bdb4e5943ab42b04a9.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1511468725').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "HP_FILESHAREBOT") # without @
...
SHORTLINK_API = environ.get("SHORTLINK_API", "7f4785525dda19ff748e7f92f1ad4fc7cac85a43") # shortlink api
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/Howtoopenlink271/41") # how to open link 
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://revolutionary-anna-hprajbots-99faf928.koyeb.app/")
